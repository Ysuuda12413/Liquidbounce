...
import net.ccbluex.liquidbounce.ui.utils.attack.CooldownHelper.getAttackCooldownProgress
import net.ccbluex.liquidbounce.ui.utils.attack.CooldownHelper.resetLastAttackedTicks
...
import net.ccbluex.liquidbounce.ui.utils.inventory.ItemUtils.isConsumingItem
...
import net.ccbluex.liquidbounce.ui.utils.render.RenderUtils.drawCircle
import net.ccbluex.liquidbounce.ui.utils.render.RenderUtils.drawEntityBox
import net.ccbluex.liquidbounce.ui.utils.render.RenderUtils.drawPlatform
import net.ccbluex.liquidbounce.ui.utils.rotation.RandomizationSettings
...
import net.ccbluex.liquidbounce.ui.utils.rotation.RotationSettings
...
import net.ccbluex.liquidbounce.ui.utils.rotation.RotationUtils.getVectorForRotation
import net.ccbluex.liquidbounce.ui.utils.rotation.RotationUtils.isRotationFaced
import net.ccbluex.liquidbounce.ui.utils.rotation.RotationUtils.isVisible
import net.ccbluex.liquidbounce.ui.utils.rotation.RotationUtils.rotationDifference
import net.ccbluex.liquidbounce.ui.utils.rotation.RotationUtils.searchCenter
import net.ccbluex.liquidbounce.ui.utils.rotation.RotationUtils.serverRotation
import net.ccbluex.liquidbounce.ui.utils.rotation.RotationUtils.setTargetRotation
...
import net.ccbluex.liquidbounce.ui.utils.timing.TimeUtils.randomClickDelay
...
object KillAura : Module("KillAura", Category.COMBAT, Keyboard.KEY_R) {
    ...
    // AutoBlock
    val autoBlock by choices("AutoBlock", arrayOf("Off", "Packet", "Fake","HoldKey"), "Packet")
